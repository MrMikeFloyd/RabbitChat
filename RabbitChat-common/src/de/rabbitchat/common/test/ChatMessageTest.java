...
public class ChatMessageTest {
	...
	public final void testMessage() {
		ChatMessage cm1 = new ChatMessage(1234, "Maik", "Moin Moin!");
		assertNotNull(cm1);
	}

	@Test
	public final void testGetId() {
		ChatMessage cm2 = new ChatMessage(1234, "Maik", "Moin Moin!");
		assertEquals(1234, cm2.getId());
	}

	@Test
	public final void testGetType() {
		ChatMessage cm3 = new ChatMessage(1234, "Maik", "Moin Moin!");
		assertEquals(MsgType.CHAT, cm3.getType());
	}

	@Test
	public final void testGetRecipient() {
		ChatMessage cm4 = new ChatMessage(1234, "Maik", "Moin Moin!");
		assertEquals("Maik", cm4.getRecipient());
	}

	@Test
	public final void testGetPayload() {
		ChatMessage cm5 = new ChatMessage(1234, "Maik", "Moin Moin!");
